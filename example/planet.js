// Generated by js_of_ocaml 3.4.0+git-a72d7f16c
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _t_=caml_new_string("Map.remove_min_elt"),
     _u_=[0,0,0,0],
     _v_=[0,caml_new_string("map.ml"),397,10],
     _w_=[0,0,0],
     _p_=caml_new_string("Map.bal"),
     _q_=caml_new_string("Map.bal"),
     _r_=caml_new_string("Map.bal"),
     _s_=caml_new_string("Map.bal"),
     _y_=caml_new_string("Stdlib.Queue.Empty"),
     _H_=caml_new_string("%c"),
     _I_=caml_new_string("%s"),
     _J_=caml_new_string("%i"),
     _K_=caml_new_string("%li"),
     _L_=caml_new_string("%ni"),
     _M_=caml_new_string("%Li"),
     _N_=caml_new_string("%f"),
     _O_=caml_new_string("%B"),
     _P_=caml_new_string("%{"),
     _Q_=caml_new_string("%}"),
     _R_=caml_new_string("%("),
     _S_=caml_new_string("%)"),
     _T_=caml_new_string("%a"),
     _U_=caml_new_string("%t"),
     _V_=caml_new_string("%?"),
     _W_=caml_new_string("%r"),
     _X_=caml_new_string("%_r"),
     _Y_=[0,caml_new_string("camlinternalFormat.ml"),846,23],
     ...
     _ae_=[0,caml_new_string("camlinternalFormat.ml"),847,23],
     _bi_=caml_new_string("%u"),
     _bg_=[0,caml_new_string("camlinternalFormat.ml"),1525,4],
     _bh_=caml_new_string("Printf: bad conversion %["),
     _bj_=[0,caml_new_string("camlinternalFormat.ml"),1593,39],
     _bk_=[0,caml_new_string("camlinternalFormat.ml"),1616,31],
     _bl_=[0,caml_new_string("camlinternalFormat.ml"),1617,31],
     _bm_=caml_new_string("Printf: bad conversion %_"),
     ...
     _bb_=caml_new_string("%.12g"),
     _a0_=caml_new_string("%nd"),
     _a1_=caml_new_string("%+nd"),
     _a2_=caml_new_string("% nd"),
     _a3_=caml_new_string("%ni"),
     ...
     _a__=caml_new_string("%no"),
     _a$_=caml_new_string("%#no"),
     _ba_=caml_new_string("%nu"),
     ...
     _aK_=caml_new_string("%Lo"),
     _aL_=caml_new_string("%#Lo"),
     _aM_=caml_new_string("%Lu"),
     ...
     _bN_=[0,[2,0,[12,10,0]],caml_new_string("%s\n")],
     _bO_=
      [0,
       [11,
        caml_new_string
       ...
       caml_new_string
        ("(Program not linked with -g, cannot print stack backtrace)\n")],
     _bF_=caml_new_string("Raised at"),
     _bG_=caml_new_string("Re-raised at"),
     _bH_=caml_new_string("Raised by primitive operation at"),
     _bI_=caml_new_string("Called from"),
     _bJ_=caml_new_string(" (inlined)"),
     ...
     _bA_=caml_new_string("Out of memory"),
     _bB_=caml_new_string("Stack overflow"),
     _bC_=caml_new_string("Pattern matching failed"),
     _bD_=caml_new_string("Assertion failed"),
     _bE_=caml_new_string("Undefined recursive module"),
     _bw_=[0,[12,40,[2,0,[2,0,[12,41,0]]]],caml_new_string("(%s%s)")],
     _bx_=caml_new_string(""),
     _by_=caml_new_string(""),
     _bz_=[0,[12,40,[2,0,[12,41,0]]],caml_new_string("(%s)")],
     _bt_=[0,[4,0,0,0,0],caml_new_string("%d")],
     _br_=[0,[3,0,0],caml_new_string("%S")],
     _bs_=caml_new_string("_"),
     _cA_=caml_new_string("OCAMLRUNPARAM"),
     _cy_=caml_new_string("CAMLRUNPARAM"),
     _bP_=caml_new_string(""),
     _bR_=caml_new_string("Js_of_ocaml__Js.Error"),
     _bS_=caml_new_string("jsError"),
     _b7_=caml_new_string("canvas"),
     _b5_=caml_new_string("img"),
     _b4_=caml_new_string("br"),
     _b3_=caml_new_string("p"),
     _b2_=caml_new_string("div"),
     _b1_=caml_new_string("label"),
     _b0_=caml_new_string("input"),
     _bZ_=caml_new_string("select"),
     _bY_=caml_new_string("option"),
     ...
     _ca_=[0,0],
     _b8_=caml_new_string("Fatal error: exception "),
     _b9_=caml_new_string("Lwt.Resolution_loop.Canceled"),
     _ci_=caml_new_string("Exception during Lwt.async: "),
     _cx_=[0,[8,0,0,[0,2],0],caml_new_string("%.2f")],
     _cr_=caml_new_string("Resume"),
     _cs_=caml_new_string("Pause"),
     _ct_=caml_new_string("Fixed position"),
     _cu_=caml_new_string("Follow rotation"),
     _cv_=caml_new_string("Lighting"),
     _cw_=caml_new_string("Clip"),
     _co_=[0,caml_new_string("examples/planet/planet.ml"),427,2],
     _cn_=[0,caml_new_string("examples/planet/planet.ml"),428,2],
     _cm_=[0,caml_new_string("examples/planet/planet.ml"),429,2],
     _cl_=[0,caml_new_string("examples/planet/planet.ml"),430,2];
    ...
    var
     backend_type=caml_sys_const_backend_type(0),
     max_array_length=caml_sys_const_max_wosize(0),
     max_string_length=(4 * max_array_length | 0) - 1 | 0;
    caml_fresh_oo_id(0);
    typeof backend_type === "number";
    function make(n,c)
       ...
       if(0 <= len)
        if((caml_ml_bytes_length(b) - len | 0) < ofs)
         ...
         {var r=caml_create_bytes(len);
          ...
          var _gP_=r,switch$0=1}
       else
        var switch$0=0;
      else
       var switch$0=0;
      if(! switch$0)var _gP_=invalid_arg(_l_);
    ...
    function contains_from(s,i,c)
     {var l=caml_ml_string_length(s);
      if(0 <= i)
       if(! (l < i))
        try
         {index_rec(s,l,i,c);var _gN_=1;return _gN_}
        catch(_gO_)
    ...
    function map(f,a)
     {var l=a.length - 1;
      if(0 === l)return [0];
      var r=caml_make_vect(l,caml_call1(f,a[1])),_gL_=l - 1 | 0,_gK_=1;
      if(! (_gL_ < 1))
       {var i=_gK_;
        for(;;)
    ...
    function _x_(Ord)
     {function height(param){if(param){var h=param[5];return h}return 0}
      function create(l,x,d,r)
       {var hl=height(l),hr=height(r),_gJ_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gJ_]}
      ...
      function bal(l,x,d,r)
       {if(l)var h=l[5],hl=h;else var hl=0;
        ...
        if((hr + 2 | 0) < hl)
         {if(l)
           {var lr=l[4],ld=l[3],lv=l[2],ll=l[1],_gE_=height(lr);
            if(_gE_ <= height(ll))return create(ll,lv,ld,create(lr,x,d,r));
            if(lr)
             {var
               lrr=lr[4],
               lrd=lr[3],
               lrv=lr[2],
               lrl=lr[1],
               _gF_=create(lrr,x,d,r);
              return create(create(ll,lv,ld,lrl),lrv,lrd,_gF_)}
            return invalid_arg(_p_)}
          return invalid_arg(_q_)}
        if((hl + 2 | 0) < hr)
         {if(r)
           {var rr=r[4],rd=r[3],rv=r[2],rl=r[1],_gG_=height(rl);
            if(_gG_ <= height(rr))return create(create(l,x,d,rl),rv,rd,rr);
            if(rl)
             {var
               rlr=rl[4],
               rld=rl[3],
               rlv=rl[2],
               rll=rl[1],
               _gH_=create(rlr,rv,rd,rr);
              return create(create(l,x,d,rll),rlv,rld,_gH_)}
            return invalid_arg(_r_)}
          return invalid_arg(_s_)}
        var _gI_=hr <= hl?hl + 1 | 0:hr + 1 | 0;
        return [0,l,x,d,r,_gI_]}
      var empty=0;
      ...
      function min_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gC_=param$0[1];
            if(_gC_){var param$0=_gC_;continue}
      ...
      function min_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gB_=param$0[1];
            if(_gB_){var param$0=_gB_;continue}
            var d=param$0[3],v=param$0[2];
            return [0,[0,v,d]]}
          return 0}}
      function max_binding(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gy_=param$0[4],_gz_=param$0[3],_gA_=param$0[2];
      ...
      function max_binding_opt(param)
       {var param$0=param;
        for(;;)
         {if(param$0)
           {var _gv_=param$0[4],_gw_=param$0[3],_gx_=param$0[2];
            if(_gv_){var param$0=_gv_;continue}
            return [0,[0,_gx_,_gw_]]}
          return 0}}
         ...
         {var _gu_=param[1];
          if(_gu_)
           {var r=param[4],d=param[3],v=param[2];
            return bal(remove_min_binding(_gu_),v,d,r)}
          var r$0=param[4];
          return r$0}
        return invalid_arg(_t_)}
      function _f9_(t,match)
       {if(t)
         {if(match)
        ...
        for(;;)
         {if(param$0)
           {var
             ...
             v=param$0[2],
             l=param$0[1],
             _gr_=caml_call2(p,v,d);
            if(_gr_)
             {var _gs_=for_all(p,l);
              if(_gs_){var param$0=r;continue}
              var _gt_=_gs_}
            else
             var _gt_=_gr_;
            return _gt_}
         ...
         {var h1=s1[5],r1=s1[4],d1=s1[3],v1=s1[2],l1=s1[1];
          if(height(s2) <= h1)
           {var
             ...
             l2=match[1],
             _gk_=merge(f,r1,r2),
             _gl_=caml_call3(f,v1,[0,d1],d2);
            return concat_or_join(merge(f,l1,l2),v1,_gl_,_gk_)}}
        else
         if(! s2)return 0;
        if(s2)
         {var
           ...
           d1$0=match$0[2],
           l1$0=match$0[1],
           _gm_=merge(f,r1$0,r2$0),
           _gn_=caml_call3(f,v2,d1$0,[0,d2$0]);
          return concat_or_join(merge(f,l1$0,l2$0),v2,_gn_,_gm_)}
      ...
      function partition(p,param)
       {if(param)
         {var
           ...
           rf=match$0[2],
           rt=match$0[1];
          if(pvd){var _gi_=concat(lf,rf);return [0,join(lt,v,d,rt),_gi_]}
          var _gj_=join(lf,v,d,rf);
          return [0,concat(lt,rt),_gj_]}
        return _w_}
         ...
         {if(e1)
           {if(e2)
             {var
               ...
               d1=e1[2],
               v1=e1[1],
               _gf_=0 === caml_call2(Ord[1],v1,v2)?1:0;
              if(_gf_)
               {var _gg_=caml_call2(cmp,d1,d2);
                if(_gg_)
                 {var
                   e2$1=cons_enum(r2,e2$0),
                   e1$1=cons_enum(r1,e1$0),
      ...
      function cardinal(param)
       {if(param)
         {var r=param[4],l=param[1],_ge_=cardinal(r);
          return (cardinal(l) + 1 | 0) + _ge_ | 0}
        return 0}
      ...
      function seq_of_enum(c,param)
       {if(c)
         {var rest=c[4],t=c[3],v=c[2],k=c[1],_gc_=cons_enum(t,rest);
          return [0,[0,k,v],function(_gd_){return seq_of_enum(_gc_,_gd_)}]}
        return 0}
      function to_seq(m)
       {var _ga_=cons_enum(m,0);
        return function(_gb_){return seq_of_enum(_ga_,_gb_)}}
    ...
    function add(x,q)
     {var cell=[0,x,0],_f8_=q[3];
      return _f8_
              ?(q[1] = q[1] + 1 | 0,_f8_[2] = cell,q[3] = cell,0)
       ...
       switch(formatting_lit[0])
        {case 0:var str=formatting_lit[1];return str;
         ...
         default:
          ...
          return _a_(_G_,caml_string_of_bytes(make(1,c)))}}
    ...
    function fmtty_rel_det(param)
     {if(typeof param === "number")
       {var
         _fI_=function(param){return 0},
         _fJ_=function(param){return 0},
         _fK_=function(param){return 0};
        return [0,function(param){return 0},_fK_,_fJ_,_fI_]}
      else
       switch(param[0])
        {case 0:
          var
           ...
           af=match[2],
           fa=match[1],
           _fL_=function(param){caml_call1(af,0);return 0};
          return [0,function(param){caml_call1(fa,0);return 0},_fL_,ed,de];
         case 1:
          var
           rest$0=param[1],
           ...
           af$0=match$0[2],
           fa$0=match$0[1],
           _fM_=function(param){caml_call1(af$0,0);return 0};
          return [0,
         ...
         case 2:
          var
           ...
           af$1=match$1[2],
           fa$1=match$1[1],
           _fN_=function(param){caml_call1(af$1,0);return 0};
          return [0,
         ...
         case 3:
          var
           ...
           af$2=match$2[2],
           fa$2=match$2[1],
           _fO_=function(param){caml_call1(af$2,0);return 0};
          return [0,
         ...
         case 4:
          var
           ...
           af$3=match$3[2],
           fa$3=match$3[1],
           _fP_=function(param){caml_call1(af$3,0);return 0};
          return [0,
         ...
         case 5:
          var
           ...
           af$4=match$4[2],
           fa$4=match$4[1],
           _fQ_=function(param){caml_call1(af$4,0);return 0};
          return [0,
         ...
         case 6:
          var
           ...
           af$5=match$5[2],
           fa$5=match$5[1],
           _fR_=function(param){caml_call1(af$5,0);return 0};
          return [0,
         ...
         case 7:
          var
           ...
           af$6=match$6[2],
           fa$6=match$6[1],
           _fS_=function(param){caml_call1(af$6,0);return 0};
          return [0,
         ...
         case 8:
          var
           ...
           af$7=match$7[2],
           fa$7=match$7[1],
           _fT_=function(param){caml_call1(af$7,0);return 0};
          return [0,
         ...
         case 9:
          var
           ...
           ga=match$9[2],
           ag=match$9[1],
           _fU_=function(param){caml_call1(jd,0);caml_call1(de$8,0);return 0},
           _fV_=function(param){caml_call1(ed$8,0);caml_call1(dj,0);return 0},
           _fW_=function(param){caml_call1(ga,0);caml_call1(af$8,0);return 0};
          return [0,
                  function(param)
         ...
         case 10:
          var
           ...
           af$9=match$10[2],
           fa$9=match$10[1],
           _fX_=function(param){caml_call1(af$9,0);return 0};
          return [0,
         ...
         case 11:
          var
           ...
           af$10=match$11[2],
           fa$10=match$11[1],
           _fY_=function(param){caml_call1(af$10,0);return 0};
          return [0,
         ...
         case 12:
          var
           ...
           af$11=match$12[2],
           fa$11=match$12[1],
           _fZ_=function(param){caml_call1(af$11,0);return 0};
          return [0,
         ...
         case 13:
          var
           ...
           af$12=match$13[2],
           fa$12=match$13[1],
           _f0_=function(param){caml_call1(de$12,0);return 0},
           _f1_=function(param){caml_call1(ed$12,0);return 0},
           _f2_=function(param){caml_call1(af$12,0);return 0};
          return [0,
         ...
         default:
          var
           ...
           af$13=match$14[2],
           fa$13=match$14[1],
           _f3_=function(param){caml_call1(de$13,0);return 0},
           _f4_=function(param){caml_call1(ed$13,0);return 0},
           _f5_=function(param){caml_call1(af$13,0);return 0};
          return [0,
       ...
       switch(ty1[0])
        {case 0:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 0:var rest2=match[1];return [0,trans(_fp_,rest2)];
         ...
         case 1:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 1:var rest2$0=match[1];return [1,trans(_fq_,rest2$0)];
         ...
         case 2:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 2:var rest2$1=match[1];return [2,trans(_fr_,rest2$1)];
         ...
         case 3:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 3:var rest2$2=match[1];return [3,trans(_fs_,rest2$2)];
         ...
         case 4:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 4:var rest2$3=match[1];return [4,trans(_ft_,rest2$3)];
         ...
         case 5:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 5:var rest2$4=match[1];return [5,trans(_fu_,rest2$4)];
         ...
         case 6:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 6:var rest2$5=match[1];return [6,trans(_fv_,rest2$5)];
         ...
         case 7:
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 7:var rest2$6=match[1];return [7,trans(_fw_,rest2$6)];
          ...
          break;
         case 8:
          var _fx_=ty1[2],_fy_=ty1[1];
          if(typeof match === "number")
           var switch$9=1;
          else
           switch(match[0])
            {case 8:
              var rest2$7=match[2],ty2=match[1],_fz_=trans(_fx_,rest2$7);
              return [8,trans(_fy_,ty2),_fz_];
          ...
          break;
         case 9:
          var _fA_=ty1[3],_fB_=ty1[2],_fC_=ty1[1];
          if(typeof match === "number")
           var switch$10=1;
          else
           switch(match[0])
            {case 8:var switch$0=5,switch$10=0;break;
             case 9:
              var
               ...
               ty22=match[2],
               ty21=match[1],
               ty=trans(symm(_fB_),ty21),
               match$0=fmtty_rel_det(ty),
               f4=match$0[4],
               f2=match$0[2];
              caml_call1(f2,0);
              caml_call1(f4,0);
              return [9,_fC_,ty22,trans(_fA_,rest2$8)];
         ...
         case 10:
          ...
          if(typeof match !== "number" && 10 === match[0])
           {var rest2$9=match[1];return [10,trans(_fD_,rest2$9)]}
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$11=0;break;
             case 11:var rest2$10=match[1];return [11,trans(_fE_,rest2$10)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$12=0;break;
             ...
             case 12:var rest2$11=match[1];return [12,trans(_fF_,rest2$11)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$13=0;break;
             ...
             case 13:var rest2$12=match[1];return [13,trans(_fG_,rest2$12)];
          ...
          if(typeof match === "number")
           ...
           switch(match[0])
            {case 10:var switch$0=0,switch$14=0;break;
             ...
             case 14:var rest2$13=match[1];return [14,trans(_fH_,rest2$13)];
             default:var switch$14=1}
          if(switch$14)throw [0,Assert_failure,_al_]}
      switch(switch$0)
       {case 0:throw [0,Assert_failure,_$_];
        ...
        case 5:throw [0,Assert_failure,_Z_];
        case 6:throw [0,Assert_failure,___];
     ...
     {var match=type_padding(pad,fmtty);
      if(typeof prec === "number")
       {if(0 === prec)
        ...
        var _fo_=match[2];
        if(typeof _fo_ !== "number" && 2 === _fo_[0])
         {var rest$0=_fo_[1],pad$1=match[1];return [0,pad$1,1,rest$0]}
        throw Type_mismatch}
        ...
        {case 0:
         ...
         case 2:
          var
           fmt_rest$1=fmt[2],
           pad=fmt[1],
           _eV_=type_padding(pad,fmtty),
           _eW_=_eV_[2],
           _eX_=_eV_[1];
          if(typeof _eW_ !== "number" && 1 === _eW_[0])
           {var
             fmtty_rest$1=_eW_[1],
             match$1=type_format_gen(fmt_rest$1,fmtty_rest$1),
             fmtty$2=match$1[2],
             fmt$2=match$1[1];
            return [0,[2,_eX_,fmt$2],fmtty$2]}
          throw Type_mismatch;
         case 3:
          var
           fmt_rest$2=fmt[2],
           pad$0=fmt[1],
           _eY_=type_padding(pad$0,fmtty),
           _eZ_=_eY_[2],
           _e0_=_eY_[1];
          if(typeof _eZ_ !== "number" && 1 === _eZ_[0])
           {var
             fmtty_rest$2=_eZ_[1],
             match$2=type_format_gen(fmt_rest$2,fmtty_rest$2),
             fmtty$3=match$2[2],
             fmt$3=match$2[1];
            return [0,[3,_e0_,fmt$3],fmtty$3]}
          throw Type_mismatch;
         case 4:
          var
           fmt_rest$3=fmt[4],
           ...
           pad$1=fmt[2],
           iconv=fmt[1],
           _e1_=type_padprec(pad$1,prec,fmtty),
           _e2_=_e1_[3],
           _e3_=_e1_[2],
           _e4_=_e1_[1];
          if(typeof _e2_ !== "number" && 2 === _e2_[0])
           {var
             fmtty_rest$3=_e2_[1],
             match$3=type_format_gen(fmt_rest$3,fmtty_rest$3),
             fmtty$4=match$3[2],
             fmt$4=match$3[1];
            return [0,[4,iconv,_e4_,_e3_,fmt$4],fmtty$4]}
          throw Type_mismatch;
         case 5:
          var
           fmt_rest$4=fmt[4],
           ...
           pad$2=fmt[2],
           iconv$0=fmt[1],
           _e5_=type_padprec(pad$2,prec$0,fmtty),
           _e6_=_e5_[3],
           _e7_=_e5_[2],
           _e8_=_e5_[1];
          if(typeof _e6_ !== "number" && 3 === _e6_[0])
           {var
             fmtty_rest$4=_e6_[1],
             match$4=type_format_gen(fmt_rest$4,fmtty_rest$4),
             fmtty$5=match$4[2],
             fmt$5=match$4[1];
            return [0,[5,iconv$0,_e8_,_e7_,fmt$5],fmtty$5]}
          throw Type_mismatch;
         case 6:
          var
           fmt_rest$5=fmt[4],
           ...
           pad$3=fmt[2],
           iconv$1=fmt[1],
           _e9_=type_padprec(pad$3,prec$1,fmtty),
           _e__=_e9_[3],
           _e$_=_e9_[2],
           _fa_=_e9_[1];
          if(typeof _e__ !== "number" && 4 === _e__[0])
           {var
             fmtty_rest$5=_e__[1],
             match$5=type_format_gen(fmt_rest$5,fmtty_rest$5),
             fmtty$6=match$5[2],
             fmt$6=match$5[1];
            return [0,[6,iconv$1,_fa_,_e$_,fmt$6],fmtty$6]}
          throw Type_mismatch;
         case 7:
          var
           fmt_rest$6=fmt[4],
           ...
           pad$4=fmt[2],
           iconv$2=fmt[1],
           _fb_=type_padprec(pad$4,prec$2,fmtty),
           _fc_=_fb_[3],
           _fd_=_fb_[2],
           _fe_=_fb_[1];
          if(typeof _fc_ !== "number" && 5 === _fc_[0])
           {var
             fmtty_rest$6=_fc_[1],
             match$6=type_format_gen(fmt_rest$6,fmtty_rest$6),
             fmtty$7=match$6[2],
             fmt$7=match$6[1];
            return [0,[7,iconv$2,_fe_,_fd_,fmt$7],fmtty$7]}
          throw Type_mismatch;
         case 8:
          var
           fmt_rest$7=fmt[4],
           ...
           pad$5=fmt[2],
           fconv=fmt[1],
           _ff_=type_padprec(pad$5,prec$3,fmtty),
           _fg_=_ff_[3],
           _fh_=_ff_[2],
           _fi_=_ff_[1];
          if(typeof _fg_ !== "number" && 6 === _fg_[0])
           {var
             fmtty_rest$7=_fg_[1],
             match$7=type_format_gen(fmt_rest$7,fmtty_rest$7),
             fmtty$8=match$7[2],
             fmt$8=match$7[1];
            return [0,[8,fconv,_fi_,_fh_,fmt$8],fmtty$8]}
          throw Type_mismatch;
         case 9:
          var
           fmt_rest$8=fmt[2],
           pad$6=fmt[1],
           _fj_=type_padding(pad$6,fmtty),
           _fk_=_fj_[2],
           _fl_=_fj_[1];
          if(typeof _fk_ !== "number" && 7 === _fk_[0])
           {var
             fmtty_rest$8=_fk_[1],
             match$8=type_format_gen(fmt_rest$8,fmtty_rest$8),
             fmtty$9=match$8[2],
             fmt$9=match$8[1];
            return [0,[9,_fl_,fmt$9],fmtty$9]}
          throw Type_mismatch;
         case 10:
          var
           fmt_rest$9=fmt[1],
         ...
         case 14:
          if(typeof fmtty !== "number" && 9 === fmtty[0])
           {var
             ...
             sub_fmtty$1=fmt[2],
             pad_opt$0=fmt[1],
             _fm_=[0,erase_rel(sub_fmtty1)];
            if(caml_notequal([0,erase_rel(sub_fmtty$1)],_fm_))
             throw Type_mismatch;
            var
            ...
            {case 0:return type_ignored_param_one(ign,rest,fmtty);
             ...
             case 9:
              var
               sub_fmtty$3=ign[2],
               pad_opt$2=ign[1],
               _fn_=type_ignored_format_substitution(sub_fmtty$3,rest,fmtty),
               match$27=_fn_[2],
               fmtty$22=match$27[2],
               fmt$22=match$27[1],
               sub_fmtty$4=_fn_[1];
         ...
         case 9:
          if(typeof match !== "number" && 9 === match[0])
           {var
             ...
             _eT_=[0,erase_rel(sub1_fmtty)];
            if(caml_notequal([0,erase_rel(sub1_fmtty$0)],_eT_))
             throw Type_mismatch;
            var _eU_=[0,erase_rel(sub2_fmtty$1)];
            if(caml_notequal([0,erase_rel(sub2_fmtty$2)],_eU_))
             throw Type_mismatch;
            var
    ...
    function fix_padding(padty,width,str)
     {var
      ...
      var _eS_=2 === padty$0?48:32,res=make(width$0,_eS_);
      switch(padty$0)
     ...
     {var n$0=caml_ml_string_length(str),i$1=0;
      for(;;)
       {if(n$0 <= i$1)
         ...
         {var
           _eQ_=caml_string_unsafe_get(str,i$1) - 32 | 0,
           switch$0=
            59 < _eQ_ >>> 0?33 < (_eQ_ - 61 | 0) >>> 0?1:0:2 === _eQ_?1:0;
          if(! switch$0){var i$2=i$1 + 1 | 0,i$1=i$2;continue}
          var
           s$0=caml_bytes_of_string(str),
           n=[0,0],
           _eI_=caml_ml_bytes_length(s$0) - 1 | 0,
           _eH_=0;
          if(! (_eI_ < 0))
           {var i$0=_eH_;
            for(;;)
             {var _eM_=caml_bytes_unsafe_get(s$0,i$0);
              if(32 <= _eM_)
               {var _eN_=_eM_ - 34 | 0;
                if(58 < _eN_ >>> 0)
                 if(93 <= _eN_)var switch$1=0,switch$2=0;else var switch$2=1;
                else
                 if(56 < (_eN_ - 1 | 0) >>> 0)
                  var switch$1=1,switch$2=0;
                 else
                  var switch$2=1;
                if(switch$2)var _eO_=1,switch$1=2}
              else
               var switch$1=11 <= _eM_?13 === _eM_?1:0:8 <= _eM_?1:0;
              switch(switch$1)
               {case 0:var _eO_=4;break;case 1:var _eO_=2;break}
              n[1] = n[1] + _eO_ | 0;
              var _eP_=i$0 + 1 | 0;
              if(_eI_ !== i$0){var i$0=_eP_;continue}
              break}}
          if(n[1] === caml_ml_bytes_length(s$0))
           ...
           {var s=caml_create_bytes(n[1]);
            n[1] = 0;
            var _eK_=caml_ml_bytes_length(s$0) - 1 | 0,_eJ_=0;
            if(! (_eK_ < 0))
             {var i=_eJ_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s$0,i);
                ...
                break}}
            var _eR_=s}
          var str$0=caml_string_of_bytes(_eR_)}
        var l=caml_ml_string_length(str$0),res=make(l + 2 | 0,34);
        caml_blit_string(str$0,0,res,1,l);
        return caml_string_of_bytes(res)}}
    function convert_int(iconv,n)
     {switch(iconv)
       {case 0:var _eG_=_an_;break;
        case 1:var _eG_=_ao_;break;
        case 2:var _eG_=_ap_;break;
        case 3:var _eG_=_aq_;break;
        case 4:var _eG_=_ar_;break;
        case 5:var _eG_=_as_;break;
        case 6:var _eG_=_at_;break;
        case 7:var _eG_=_au_;break;
        case 8:var _eG_=_av_;break;
        case 9:var _eG_=_aw_;break;
        case 10:var _eG_=_ax_;break;
        case 11:var _eG_=_ay_;break;
        default:var _eG_=_az_}
      return caml_format_int(_eG_,n)}
    function convert_int32(iconv,n)
     {switch(iconv)
       {case 0:var _eF_=_aN_;break;
        case 1:var _eF_=_aO_;break;
        case 2:var _eF_=_aP_;break;
        case 3:var _eF_=_aQ_;break;
        case 4:var _eF_=_aR_;break;
        case 5:var _eF_=_aS_;break;
        case 6:var _eF_=_aT_;break;
        case 7:var _eF_=_aU_;break;
        case 8:var _eF_=_aV_;break;
        case 9:var _eF_=_aW_;break;
        case 10:var _eF_=_aX_;break;
        case 11:var _eF_=_aY_;break;
        default:var _eF_=_aZ_}
      return caml_format_int(_eF_,n)}
    function convert_nativeint(iconv,n)
     {switch(iconv)
       {case 0:var _eE_=_a0_;break;
        case 1:var _eE_=_a1_;break;
        case 2:var _eE_=_a2_;break;
        case 3:var _eE_=_a3_;break;
        case 4:var _eE_=_a4_;break;
        case 5:var _eE_=_a5_;break;
        case 6:var _eE_=_a6_;break;
        case 7:var _eE_=_a7_;break;
        case 8:var _eE_=_a8_;break;
        case 9:var _eE_=_a9_;break;
        case 10:var _eE_=_a__;break;
        case 11:var _eE_=_a$_;break;
        default:var _eE_=_ba_}
      return caml_format_int(_eE_,n)}
    function convert_int64(iconv,n)
     {switch(iconv)
       {case 0:var _eD_=_aA_;break;
        case 1:var _eD_=_aB_;break;
        case 2:var _eD_=_aC_;break;
        case 3:var _eD_=_aD_;break;
        case 4:var _eD_=_aE_;break;
        case 5:var _eD_=_aF_;break;
        case 6:var _eD_=_aG_;break;
        case 7:var _eD_=_aH_;break;
        case 8:var _eD_=_aI_;break;
        case 9:var _eD_=_aJ_;break;
        case 10:var _eD_=_aK_;break;
        case 11:var _eD_=_aL_;break;
        default:var _eD_=_aM_}
      return caml_int64_format(_eD_,n)}
     ...
     {if(16 <= fconv)
        ...
        if(19 <= fconv)
         {var s=caml_bytes_of_string(s$0),l=caml_ml_bytes_length(s);
          if(0 === l)
           ...
           {var r=caml_create_bytes(l),_ev_=l - 1 | 0,_eu_=0;
            if(! (_ev_ < 0))
             {var i=_eu_;
              for(;;)
               {var c=caml_bytes_unsafe_get(s,i);
                if(97 <= c)
                 if(122 < c)
                  ...
                  var _ew_=c - 32 | 0,switch$1=1;
                else
                 var switch$1=0;
                if(! switch$1)var _ew_=c;
                caml_bytes_unsafe_set(r,i,_ew_);
                var _ex_=i + 1 | 0;
      ...
      if(15 === fconv)
       ...
       {var prec=abs(prec$0);
        ...
        var _ez_=buffer_contents(buf)}
      var str=caml_format_float(_ez_,x);
      if(15 === fconv)
       {var len=caml_ml_string_length(str),_eB_=caml_classify_float(x);
        if(3 === _eB_)return x < 0.?_bc_:_bd_;
        if(4 <= _eB_)return _be_;
        var i$0=0;
        for(;;)
         {if(i$0 === len)
           var _eC_=0;
    ...
    function make_int_padding_precision(k,o,acc,fmt,pad,match,trans,iconv)
     {if(typeof pad === "number")
       ...
       {if(0 === pad[0])
         {var _er_=pad[2],_es_=pad[1];
          if(typeof match === "number")
           return 0 === match
                   ?function(x)
                     {var str=fix_padding(_es_,_er_,caml_call2(trans,iconv,x));
                      return make_printf(k,o,[4,acc,str],fmt)}
                   :function(p,x)
                     {var
                       str=
                        fix_padding
                         (_es_,_er_,fix_int_precision(p,caml_call2(trans,iconv,x)));
                      return make_printf(k,o,[4,acc,str],fmt)};
          var p$0=match[1];
          return function(x)
           {var
             str=
              fix_padding
               (_es_,_er_,fix_int_precision(p$0,caml_call2(trans,iconv,x)));
            return make_printf(k,o,[4,acc,str],fmt)}}
        var _et_=pad[1];
        if(typeof match === "number")
         return 0 === match
                 ?function(w,x)
                   {var str=fix_padding(_et_,w,caml_call2(trans,iconv,x));
                    return make_printf(k,o,[4,acc,str],fmt)}
                 :function(w,p,x)
                   {var
                     str=
                      fix_padding
                       (_et_,w,fix_int_precision(p,caml_call2(trans,iconv,x)));
                    return make_printf(k,o,[4,acc,str],fmt)};
        var p$1=match[1];
        return function(w,x)
         {var
           str=
            fix_padding
             (_et_,w,fix_int_precision(p$1,caml_call2(trans,iconv,x)));
          return make_printf(k,o,[4,acc,str],fmt)}}}
         ...
         {case 0:
          ...
          case 8:
           ...
           if(typeof pad$5 === "number")
            ...
            {if(0 === pad$5[0])
              {var _en_=pad$5[2],_eo_=pad$5[1];
               if(typeof prec$3 === "number")
                return 0 === prec$3
                        ?function(x)
                          {var
                            str=convert_float(fconv,default_float_precision,x),
                            str$0=fix_padding(_eo_,_en_,str);
                           return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                        :function(p,x)
                          {var str=fix_padding(_eo_,_en_,convert_float(fconv,p,x));
                           return make_printf(k$0,o,[4,acc$0,str],rest$7)};
               var p$0=prec$3[1];
               return function(x)
                {var str=fix_padding(_eo_,_en_,convert_float(fconv,p$0,x));
                 return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
             var _ep_=pad$5[1];
             if(typeof prec$3 === "number")
              return 0 === prec$3
                      ?function(w,x)
                        {var
                          str=convert_float(fconv,default_float_precision,x),
                          str$0=fix_padding(_ep_,w,str);
                         return make_printf(k$0,o,[4,acc$0,str$0],rest$7)}
                      :function(w,p,x)
                        {var str=fix_padding(_ep_,w,convert_float(fconv,p,x));
                         return make_printf(k$0,o,[4,acc$0,str],rest$7)};
             var p$1=prec$3[1];
             return function(w,x)
              {var str=fix_padding(_ep_,w,convert_float(fconv,p$1,x));
               return make_printf(k$0,o,[4,acc$0,str],rest$7)}}
          case 9:
          ...
          case 14:
           ...
           return function(param)
            {var
              ...
              _eq_=type_format_gen(fmt$0,fmtty$0);
             if(typeof _eq_[2] === "number")
              {var fmt=_eq_[1];
          ...
          case 18:
           ...
           var
            ...
            fmt$0=fmt$6;
           continue;
          case 19:throw [0,Assert_failure,_bg_];
          case 20:
           var rest$15=fmt$0[3],new_acc=[8,acc$0,_bh_];
           return function(param){return make_printf(k$0,o,new_acc,rest$15)};
          case 21:
           var rest$16=fmt$0[2];
           return function(n)
            {var new_acc=[4,acc$0,caml_format_int(_bi_,n)];
            ...
            switch(ign)
             {case 0:
              ...
              case 1:
               ...
               return caml_trampoline_return
                       (make_invalid_arg,[0,k$0,o,acc$0,rest$18]);
              case 2:throw [0,Assert_failure,_bj_];
              default:
               if(counter < 50)
          ...
          default:
           ...
           if(counter < 50)
            {var counter$0=counter + 1 | 0;
             return make_custom$0(counter$0,k$0,o,acc$0,rest$19,arity,_em_)}
           return caml_trampoline_return
                   (make_custom$0,[0,k$0,o,acc$0,rest$19,arity,_em_])}}
     ...
     {if(typeof fmtty === "number")
       ...
       switch(fmtty[0])
        {case 0:
         ...
         case 13:throw [0,Assert_failure,_bk_];
         default:throw [0,Assert_failure,_bl_]}}
    function make_invalid_arg(counter,k,o,acc,fmt)
     {var _ej_=[8,acc,_bm_];
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_ej_,fmt)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_ej_,fmt])}
    function make_custom$0(counter,k,o,acc,rest,arity,f)
     {if(arity)
      ...
      if(counter < 50)
       {var counter$0=counter + 1 | 0;
        return make_printf$0(counter$0,k,o,_ei_,rest)}
      return caml_trampoline_return(make_printf$0,[0,k,o,_ei_,rest])}
    ...
    function fprintf(oc,fmt$0)
     {var fmt=fmt$0[1],_ed_=0;
      return make_printf
              (function(o,acc){output_acc(o,acc);return 0},oc,_ed_,fmt)}
         ...
         {var s=caml_format_float(_e_,a),l=caml_ml_string_length(s),i=0;
          for(;;)
           {if(l <= i)return _a_(s,_d_);
            var
             _ec_=caml_string_get(s,i),
             switch$0=48 <= _ec_?58 <= _ec_?0:1:45 === _ec_?1:0;
    ...
    function other_fields(x,i)
     {if(x.length - 1 <= i)return _bu_;
      var _ea_=other_fields(x,i + 1 | 0),_eb_=field(x,i);
      return caml_call2(sprintf(_bv_),_eb_,_ea_)}
    function fields(x)
     {var _d8_=x.length - 1;
      if(2 < _d8_ >>> 0)
       {var _d9_=other_fields(x,2),_d__=field(x,1);
        return caml_call2(sprintf(_bw_),_d__,_d9_)}
      switch(_d8_)
       {case 0:return _bx_;
        case 1:return _by_;
        default:var _d$_=field(x,1);return caml_call1(sprintf(_bz_),_d$_)}}
        ...
        for(;;)
         {if(param$0)
           {var tl=param$0[2],hd=param$0[1];
            try {var _d6_=caml_call1(hd,x),_d5_=_d6_}catch(_d7_){var _d5_=0}
            if(_d5_){var s=_d5_[1];return s}
            var param$0=tl;
            continue}
          if(x === Out_of_memory)return _bA_;
          if(x === Stack_overflow)return _bB_;
          if(x[1] === Match_failure)
           {var match=x[2],char$0=match[3],line=match[2],file=match[1];
            return caml_call5
                    (sprintf(locfmt),file,line,char$0,char$0 + 5 | 0,_bC_)}
          if(x[1] === Assert_failure)
           {var
             ...
             file$0=match$0[1];
            return caml_call5
                    (sprintf(locfmt),file$0,line$0,char$1,char$1 + 6 | 0,_bD_)}
          if(x[1] === Undefined_recursive_module)
           {var
             ...
             file$1=match$1[1];
            return caml_call5
                    (sprintf(locfmt),file$1,line$1,char$2,char$2 + 6 | 0,_bE_)}
          if(0 === caml_obj_tag(x))
    ...
    function print_backtrace(outchan)
     {var
       ...
       backtrace=[0,a];
      if(backtrace)
       {var _d3_=a.length - 1 - 1 | 0,_d2_=0;
        if(! (_d3_ < 0))
         {var i=_d2_;
          for(;;)
           {var
             ...
             info$0=
              function(i)
               {function info(is_raise)
                 {return is_raise?0 === i?_bF_:_bG_:0 === i?_bH_:_bI_}
                return info},
             info=info$0(i);
            if(0 === slot[0])
             var
              ...
              _dW_=slot[4],
              _dX_=slot[3],
              _dY_=slot[6]?_bJ_:_bL_,
              _dZ_=slot[2],
              _d0_=info(slot[1]),
              match=
               [0,caml_call6(sprintf(_bK_),_d0_,_dZ_,_dY_,_dX_,_dW_,_dV_)];
            else
             if(slot[1])
              var match=0;
             else
              var _d1_=info(0),match=[0,caml_call1(sprintf(_bM_),_d1_)];
            if(match){var str=match[1];caml_call1(fprintf(outchan,_bN_),str)}
            var _d4_=i + 1 | 0;
            if(_d3_ !== i){var i=_d4_;continue}
            break}}
        return 0}
      return fprintf(outchan,_bO_)}
    function register_printer(fn){printers[1] = [0,fn,printers[1]];return 0}
    try
     {var _cB_=caml_sys_getenv(_cA_),params=_cB_}
    catch(_dT_)
     {_dT_ = caml_wrap_exception(_dT_);
      if(_dT_ !== Not_found)throw _dT_;
      try
       {var _cz_=caml_sys_getenv(_cy_),_bQ_=_cz_}
      catch(_dU_)
       {_dU_ = caml_wrap_exception(_dU_);
        if(_dU_ !== Not_found)throw _dU_;
        var _bQ_=_bP_}
      var params=_bQ_}
    contains(params,82);
    ...
    var
     ...
     date_ms=window.Date,
     Error=[248,_bR_,caml_fresh_oo_id(0)];
    register_exception(_bS_,[0,Error,{}]);
     ...
     {if(e.addEventListener === undefined$0)
       {var
         ...
         callback=
          function(e)
           {var _dQ_=[0,h,e,[0]];
            return function(_dR_,_dS_){return caml_js_call(_dQ_,_dR_,_dS_)}};
    ...
    function _bT_(x,f){if(x){var v=x[1];return caml_call1(f,v)}return 0}
    function _bU_(doc,name){return doc.createElement(name.toString())}
    function _bV_(doc,name){return _bU_(doc,name)}
    var _bW_=[0,785140586];
    function _bX_(type,name,doc$0,elt)
     {for(;;)
       {if(0 === type)if(0 === name)return _bU_(doc$0,elt);
        var _dK_=_bW_[1];
        if(785140586 === _dK_)
         {try
           {var
             el=doc.createElement('<input name="x">'),
             _dN_=el.tagName.toLowerCase() === "input"?1:0,
             _dO_=_dN_?el.name === "x"?1:0:_dN_,
             _dL_=_dO_}
          catch(_dP_){var _dL_=0}
          var _dM_=_dL_?982028505:-1003883683;
          _bW_[1] = _dM_;
          continue}
        if(982028505 <= _dK_)
        ...
        var res=_bU_(doc$0,elt);
        _bT_(type,function(t){return res.type = t});
        _bT_(name,function(n){return res.name = n});
        return res}}
    function createInput(type,name,doc){return _bX_(type,name,doc,_b0_)}
    function createLabel(doc){return _bV_(doc,_b1_)}
    function createDiv(doc){return _bV_(doc,_b2_)}
    var
    ...
    var compare=caml_compare,Storage_map=_x_([0,compare]);
     ...
     {var _dJ_=p[1];
      switch(_dJ_[0])
       {case 0:return p;
        ...
        case 2:return p;
        default:
         var p$0=_dJ_[1],p$1=underlying(p$0);
    ...
    function add_implicitly_removed_callback(callbacks,f)
     {var
       node$0=[1,f],
       _dI_=callbacks[1],
       node=typeof _dI_ === "number"?node$0:[0,node$0,_dI_];
      callbacks[1] = node;
      return 0}
    var
    ...
    function handle_with_async_exception_hook(f,v)
     {try
       {var _dH_=caml_call1(f,v);return _dH_}
      catch(exn)
    ...
    function run_callbacks(callbacks,result)
     {if(1 === result[0])
       var _dF_=result[1] === Canceled?1:0,is_canceled=_dF_;
      else
       var is_canceled=0;
      if(is_canceled)
       {var
        ...
        iter_callback_list(_dD_,0)}
      var _dE_=callbacks[1];
      ...
      return iter_callback_list$0(_dE_,0)}
    var
      ...
      if(1 === current_callback_nesting_depth[1])
       for(;;)
        {if(0 !== q[1])
          {var _dA_=q[2];
           if(_dA_)
            {var _dB_=_dA_[1],_dC_=_dA_[2];
             if(_dC_)
              {q[1] = q[1] - 1 | 0;q[2] = _dC_}
             else
              {q[1] = 0;q[2] = 0;q[3] = 0}
             var result=_dB_[2],callbacks=_dB_[1];
     ...
     {var p=underlying(r),_dz_=p[1];
      switch(_dz_[0])
       {case 1:
        ...
        case 2:var result=[0,exn];resolve(_ca_,0,p,result);return 0;
        default:
      ...
      switch(_dy_[0])
       {case 1:return resolve(_cc_,0,outer_promise,p[1]);
        case 2:
         ...
         var
          _dw_=p_callbacks[2],
          _dx_=outer_callbacks[2],
          cancel_callbacks=
           typeof _dx_ === "number"
            ?_dw_
            :typeof _dw_ === "number"?_dx_:[0,_dx_,_dw_];
      ...
      function create_result_promise_and_callback_if_deferred(param)
       {var match=new_pending([0,p]),saved_storage=current_storage[1];
        function callback(p_result)
         {if(1 === p_result[0])
           {var p$1=underlying(match);resolve(_cd_,0,p$1,p_result);return 0}
          var v=p_result[1];
          current_storage[1] = saved_storage;
          try
           {var _dv_=caml_call1(f,v),p=_dv_}
       ...
       {case 1:return [0,_dt_];
        ...
        default:
         ...
         return run_callback_or_defer_it
                 (_ce_,function(param){return caml_call1(f,v)},_du_)}}
    var pause_hook=[0,function(_ds_){return 0}],s1=create$0(0),_ch_=[0,0];
     ...
     {var match=task(0),w=match[2],t=match[1],d$0=d * 1000.;
      ...
      function loop(step,param)
       {if(2147483000. < step)
        ...
        var cb=remain == 0.?callback:function(_dp_){return loop(remain,_dp_)};
    ...
    function checkbox(txt,checked,action)
     {var b=createInput([0,"checkbox"],0,doc);
      ...
      add$0(lab,b);
      add$0(lab,doc.createTextNode(txt.toString()));
      return lab}
    ...
    function rotate_object(m,o)
     {var _dh_=o[2],_di_=o[1];
      return [0,map(function(v){return matrix_vect_mul(m,v)},_di_),_dh_]}
    function _ck_(p_div,t_div)
     {var
      ...
      var _c5_=p_div - 1 | 0,_c4_=0;
      if(! (_c5_ < 0))
       {var i=_c4_;
        for(;;)
         {var _c7_=t_div - 1 | 0,_c6_=0;
          if(! (_c7_ < 0))
           {var j=_c6_;
            for(;;)
             {var
              ...
              if(0 === j)
               {var
                 _c__=2 * k | 0,
                 _c9_=[0,north,k,caml_mod(k + t_div | 0,north)];
                ...
                var
                 ...
                 _c$_=
                  [0,
                   ...
                   (k + t_div | 0) - 1 | 0];
                caml_check_bound(faces,_da_)[1 + _da_] = _c$_}
              else
               {var
                 _dd_=2 * k | 0,
                 _dc_=[0,k,caml_mod(k + t_div | 0,north),k - 1 | 0];
                caml_check_bound(faces,_dd_)[1 + _dd_] = _dc_;
                var
                 _de_=caml_mod((k + t_div | 0) - 1 | 0,north),
                 _dg_=(2 * k | 0) + 1 | 0,
                 _df_=[0,k - 1 | 0,caml_mod(k + t_div | 0,north),_de_];
                caml_check_bound(faces,_dg_)[1 + _dg_] = _df_}
              var _db_=j + 1 | 0;
              if(_c7_ !== j){var j=_db_;continue}
              break}}
          var _c8_=i + 1 | 0;
    ...
    function create_canvas(w,h)
     {var c=_bV_(doc,_b7_);
      ...
      c.height = h;
      return c}
    function _cp_(u,v){return u < v?u:v}
    function _cq_(u,v){return u < v?v:u}
    function draw(ctx,img,shd,o,uv,normals,face_info,dir)
     {var _c3_=o[2],_c1_=_c3_.length - 1 - 1 | 0,_c0_=0;
      if(! (_c1_ < 0))
       {var i=_c0_;
        for(;;)
         {var
          ...
          if(0. <= x1 * x2 + y1 * y2 + z1 * z2)
           {ctx.beginPath();
            ...
            ctx.restore()}
          var _c2_=i + 1 | 0;
          if(_c1_ !== i){var i=_c2_;continue}
          break}}
      return 0}
    var o=_ck_(12,8),src="../planet/texture.jpg";
    window.onload
    =
    handler
     (function(param$0)
       {function _cE_(texture)
         {var
           w=texture.width,
           h=texture.height,
                 ...
                 {var i=_cW_;
                  for(;;)
                   {var
                    ...
                    data[k$0 + 3 | 0] = c$1;
                    var _cZ_=i + 1 | 0;
                    if(_cX_ !== i){var i=_cZ_;continue}
                    break}}
                var _cY_=j + 1 | 0;
                if(_cV_ !== j){var j=_cY_;continue}
                break}}
          ...
          function update_texture(lighting,phi)
           {if(lighting)
            ...
            var
             _cS_=1 - no_lighting[1],
             _cT_=
              _cS_?(ctx$0.drawImage(texture,0.,0.),no_lighting[1] = 1,0):_cS_;
            return _cT_}
          var
           canvas$0=create_canvas(width,width),
           canvas$1=create_canvas(width,width);
          add$0(doc.body,canvas$0);
          var
             ...
             (function(v$0)
               {var
                ...
                if(0. <= u)
                 {if(u < tw)
                   {if(0. <= v)
                     {if(v < th)return [0,u,v];throw [0,Assert_failure,_cl_]}
             ...
             (function(f)
               {var
                ...
                var
                 ...
                 du3$0=du3 / su,
                 du2$0=du2 / su,
                 u=_cq_(0.,_cp_(u1$2,_cp_(u2$2,u3$2)) - 4.),
                 v=_cq_(0.,_cp_(v1$1,_cp_(v2$1,v3$1)) - 4.),
                 u$0=_cp_(tw,_cq_(u1$2,_cq_(u2$2,u3$2)) + 4.),
                 v$0=_cp_(th,_cq_(v1$1,_cq_(v2$1,v3$1)) + 4.),
                 du=u$0 - u,
                 dv=v$0 - v;
          ...
          add$0(d$0,doc.createTextNode("Click and drag mouse to rotate."));
          add$0(ctrl,d$0);
          var form=createDiv(doc);
          function br(param){return _bV_(doc,_b4_)}
          add$0
           (form,toggle_button(_cs_,_cr_,function(p){paused[1] = p;return 0}));
          add$0(form,br(0));
          add$0
           (form,toggle_button(_cu_,_ct_,function(f){follow[1] = f;return 0}));
          add$0(form,br(0));
          var b=createInput([0,_cj_],0,doc);
          ...
          add$0(form,br(0));
          var lab=createLabel(doc);
          add$0(lab,doc.createTextNode("Date:"));
          var s=_bX_(0,0,doc,_bZ_),param$0=param;
          for(;;)
           {if(param$0)
             {var l=param$0[2],a=param$0[1],o$0=_bV_(doc,_bY_);
              add$0(o$0,doc.createTextNode(a.toString()));
            ...
            handler
             (function(param)
               {var
                 _cQ_=s.selectedIndex,
                 o=0 === _cQ_?obliquity:1 === _cQ_?0.:-0.410152374218667459;
                update_shadow(o);
                obl[1] = o;
                return true$0});
            add$0(lab,s);
            ...
            add$0
             (form$0,checkbox(_cv_,1,function(l){lighting[1] = l;return 0}));
            add$0(form$0,br(0));
            add$0
             (form$0,checkbox(_cw_,1,function(l){clipped[1] = l;return 0}));
            add$0(form$0,br(0));
            add$0(form$0,doc.createTextNode("Frames per second: "));
                    ...
                    handler
                     (function(ev)
                       {var
                        ...
                        if(0 !== dx)
                         {var _cP_=m[1];
                          m[1] = matrix_mul(xz_rotation(2. * dx / 600),_cP_)}
                        mx[1] = x;
                        my[1] = y;
                        return true$0}),
                    true$0),
                 ...
                 (doc,
                  ...
                  handler
                   (function(param)
                     {f(c1);
                      var _cO_=c2[1];
                      if(1 - (_cO_ == no_handler?1:0))f(_cO_);
                      return true$0}),
                  true$0);
                return false$0});
            var
             ...
             loop=
              function(t,phi)
               {var rotation=xz_rotation(phi - phi_rot[1]);
                ...
                var
                 _cI_=matrix_mul(m_obliq[1],rotation),
                 m$0=matrix_mul(m[1],_cI_),
                ...
                try {ctx$1.getImageData(0.,0.,1.,1.)}catch(_cN_){}
                var
                ...
                fps[1] = hz$0;
                var _cJ_=fps[1];
                rateText.data = caml_call1(sprintf(_cx_),_cJ_).toString();
                ti[1] = t$0;
                function _cK_(param)
                 {var
                   t$0=new date_ms().getTime(),
                   ...
                   _cL_=1 - paused[1],
                   _cM_=_cL_?follow[1]:_cL_;
                  if(_cM_)phi_rot[1] = phi_rot[1] + angle;
                  var phi$0=paused[1]?phi:phi + angle;
                  return loop(t$0,phi$0)}
                return bind(sleep(0.01),_cK_)};
            return loop(new date_ms().getTime(),0.)}}
        var v$0=_bV_(doc,_b5_);
        function _cD_(param){return [0,[0,v$0]]}
        var match=task(0),w=match[2],t=match[1];
        v$0.onload = handler(function(param){wakeup(w,0);return false$0});
        v$0.src = src;
        var match$0=bind(bind(t,_cD_),_cE_),_cC_=underlying(match$0)[1];
        switch(_cC_[0])
         {case 1:var exn=_cC_[1];throw exn;
          case 2:
           var
            p_callbacks=_cC_[1],
            callback=
